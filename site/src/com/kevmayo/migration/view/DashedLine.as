...
package com.kevmayo.migration.view{
	...
	class DashedLine {
		 ...
		 * @return nothing
		 */
		public function setDash(onLength:Number, offLength:Number){
		...
		public function curveTo(cx:Number, cy:Number, x:Number, y:Number){
		 ...
		 * @return nothing
		 */
		public function lineStyle(thickness:Number,rgb:Number,alpha:Number){
		 ...
		 * @return nothing
		 */
		public function beginFill(rgb:Number,alpha:Number){
		 ...
		 * @return nothing
		 */
		public function beginGradientFill(fillType:String,colors:Array,alphas:Array,ratios:Array,matrix:Object){
		...
		private function targetMoveTo(x:Number, y:Number){
			this.pen={x:x,y:y};
			this.target.moveTo(x, y);
		}
		private function targetLineTo(x:Number, y:Number){
		...
		private function targetCurveTo(cx:Number, cy:Number, x:Number, y:Number){
