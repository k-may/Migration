package com.kevmayo.migration.view
{
	...
	public class MenuContainer extends Sprite
	{
		...
		public function MenuContainer(_h:int, _mainNodeSize:int)
		{
			this.h=_h;
		...
		private function init()
		{
			...
			var sort_nameNode:Node=new Node(mainNodeSize, 0XFDDFF4, 0xCAFDAD, 0X7E7F81, 1, true);
			...
			var sort_dateNode:Node=new Node(mainNodeSize, 0XFDDFF4, 0xCAFDAD, 0X7E7F81, 1, false);
			...
			var sort_freqNode:Node=new Node(mainNodeSize, 0XFDDFF4, 0xCAFDAD, 0X7E7F81, 1, false);
		...
		private function sortHandler(e:Event)
		{
			...
			switch (e.type)
			{
				...
				case "click":
					...
					{
						if ((sortMenu.getChildAt(i) as Node).lineVisible)
						{
							trace("sortMenu.getChildAt(i) = " + sortMenu.getChildAt(i));
							(sortMenu.getChildAt(i) as Node)._mouseDown(false);
