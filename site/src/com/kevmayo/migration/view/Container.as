	...
	//textfields
		...
		public function update():void
		{
			...
			if (_invalidated)
			{
				...
				_menuContainer.height = this.height;
...
//			_trajContainer.update();
		...
		public function getMenuWidth():int
		{
			...
			/*if (isMenuOpen())
				return getMaxMenuWidth();
			else
				return getMinMenuWidth()*/
		}
		...
		private function onMenuSelected(e:Event){
			
			if (isMenuOpen())
				_menuContainer.width = getMaxMenuWidth();
			else
